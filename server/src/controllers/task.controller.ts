...
const getTask = asyncHandler(async (req:Request, res:Response):Promise<any> => {
...
const createTask = asyncHandler(async (req:Request, res:Response):Promise<any> => {
    const user = req.session;
...
const updateTask = asyncHandler(async (req: Request, res: Response): Promise<any> => {
...
const deleteTask = asyncHandler(async (req:Request, res:Response):Promise<any> => {
    const { task_id, org_id } = req.params;
    const user = req.session;
